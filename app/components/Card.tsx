...
const Card: React.FC<CardProps> = (
    ...
    return (
        <div ref={container} className='h-screen flex items-center justify-center sticky top-0'>
            <motion.div style={{ backgroundColor: feature.color, scale, top: `calc(-5vh + ${i * 25}px)` }} className='flex flex-col relative -top-[25%] h-[500px] w-[1000px] rounded-2xl p-[50px] origin-top'>
                ...
                <div className="flex h-full mt-[50px] gap-12">
                    <div className="w-[40%] relative top-[10%]">
                        ...
                        <span className='flex items-center gap-1'>
                            <Link className='text-[12px] underline cursor-pointer' href="/" target="_blank">See more</Link>
